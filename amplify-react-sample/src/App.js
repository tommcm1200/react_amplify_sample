...
const Home = () => {
  function createData(firstName, lastName, movies, age) {
    return { firstName, lastName, movies, age};
  }
  ...
  const headCells = [
    ...
    { id: 'Movies', numeric: false, disablePadding: false, label: 'Movies' },
  ...
  const EnhancedTableToolbar = (props) => {
    ...
    const { whichSelected } = props;
    

    function saveShows() {
      
      var json = Object.assign({}, whichSelected);
      console.log (json);
      ...
      >
        ...
        {numSelected > 0 ? (
          <Tooltip title="Generate">
            <IconButton aria-label="Generate" onClick={saveShows}>
              <SaveAltIcon />
            </IconButton>
          </Tooltip>
        ) : (
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = actors.map((n) => n.firstName);
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} whichSelected={selected} />
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.movies}</TableCell>
